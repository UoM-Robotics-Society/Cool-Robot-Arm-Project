...
class LineSearch {
   ...
   public:
    double min_angle[CRAP_NUM_REVOLUTE_FRAMES] = {
        -LA::Pi / 2, -LA::Pi / 2, -2 * LA::Pi / 3, -LA::Pi / 2, -LA::Pi};
    ...
    */
    bool InBoundsPos(LA::vecd<3> pos);
    // bool InBoundsPos(double x, double y, double z);
    /*
    ...
    */
    ...
    bool InBounds(LA::vecd<5> angles, bool verbose);

    // Fill documentation
    LA::vecd<5> GetAngleBounds(LA::vecd<5> current_pos,
                               LA::vecd<5> direction);
    ...
    LA::vecd<5> GoldenSearch(LA::vecd<5> current_pos, LA::vecd<5> direction,
                             double mu);
};