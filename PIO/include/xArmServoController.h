...
class xArmServoController {
   public:
    ...
    void setPosition(int servo_id, unsigned position,
                     unsigned duration = 1000, bool wait = false);
    void setPosition(xArmServo servo, unsigned duration = 1000,
                     bool wait = false);
    void setPosition(xArmServo servos[], int count, unsigned duration = 1000,
                     bool wait = false);
