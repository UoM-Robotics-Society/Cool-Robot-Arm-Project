...
class BFGS {
   ...
   public:
    ...
    // pass in pointer for output motors as it will fill vector with target
    // motor positions calls reset for you
    bool Run(double x, double y, double z, LA::vecd<5> current_motors,
